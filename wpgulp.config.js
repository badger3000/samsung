...
module.exports = {
	...
	// Project options.
	projectURL: 'localhost:3000/samsung-test/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'SAMSUNGNXT', // Your textdomain here.
	translationFile: 'SAMSUNGNXT.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'SAMSUNGNXT', // Package name.
	bugReport: 'https://notmyfault.com/contact/', // Where can users report bugs.
	lastTranslator: 'Kyle Ross <your_email@email.com>', // Last translator Email ID.
	team: 'Kyle Ross <your_email@email.com>', // Team's Email ID.

...
var themeJS = {
    ...
    var getValue = container.getBoundingClientRect();

    //this sets the container to align with the grid container when page loads
    ...
    window.addEventListener('resize', function(event){
      ...
      var getValue = container.getBoundingClientRect();
       ...
       //set the new value, this is repetive, should be done different
      viewPort.style.marginLeft = getValue.left + 'px';
    });
  },
  onHover: function(){
